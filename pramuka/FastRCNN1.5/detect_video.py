...
# Load the model
num_classes = 6  # 5 tree types + background
...
# Define class names (index 0 = background)
class_names = ["background", "Tree1", "Tree2", "Tree3", "Tree4", "Tree5"]

# Video paths
input_path = "20250609_155155.mp4"
