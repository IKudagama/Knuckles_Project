...
train_ann = os.path.join(train_dir, "train", "train.json")
val_ann = os.path.join(val_dir, "valid", "valid.json")
...
train_dataset = CocoDetectionTransform(os.path.join(train_dir, "images"), train_ann, train=True)
val_dataset = CocoDetectionTransform(os.path.join(val_dir, "images"), val_ann, train=False)
...
def evaluate(model, data_loader, device):
    ...
    precision = coco_eval.stats[0]  # AP@[.5:.95]
